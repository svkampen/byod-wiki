...
![Ubuntu installer BitLocker warning](./2004-bitlocker.png)
...
![BitLocker settings](./bitlocker-settings.png)
...
![BitLocker recovery sleutel exporteren](./bitlocker-export-recovery.png)
...
![Disk partitie verkleinen](./bitlocker-resize-partition.png)
